...
public class Cuenta {
    ...
    public void agregarTarjetaCredito(int saldo){
      tarjetas.add(new TarjetaCredito(this,saldo));
    }
    public void agregarTarjetaDebito() {
      tarjetas.add(new TarjetaDebito(this));
    }
    public double getSaldoReal(){
      double saldoReal = saldo;
      for(Tarjeta t : tarjetas)
        if (t instanceof TarjetaCredito tc)
          saldoReal -= tc.getSaldo();
      return saldoReal;
    }
    /* Hay que respetar los argumentos de los métodos ya que se podrán 
       usar los métodos de clase suministrados en Tarjeta
     */
    /*
     * 
     * 
